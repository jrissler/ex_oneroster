defmodule ExOneroster.UsersTest do
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert user.identifier == user_params.identifier
      ...
      assert user.type == user_params.type
      assert user.userIds == user_params.userIds
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert user.identifier == existing_user.identifier
      ...
      assert user.type == existing_user.type
      assert user.userIds == existing_user.userIds
